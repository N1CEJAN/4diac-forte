...
class CIEC_ROS2_conversiontests_msg_Ros2Arrayspezifikationen6 final : public CIEC_STRUCT {
  ...
  public:
    ...
    CIEC_ARRAY_FIXED<CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen, 0, 2> var_absolute_reference;
    CIEC_ULINT var_absolute_reference_element_counter;
    CIEC_ARRAY_FIXED<CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen, 0, 2> var_relative_reference;
