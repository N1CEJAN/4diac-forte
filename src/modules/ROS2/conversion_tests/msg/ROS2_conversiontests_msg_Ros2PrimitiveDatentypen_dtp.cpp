...
const CStringDictionary::TStringId CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen::scmElementNames[] = {g_nStringIda_bool, g_nStringIda_byte, g_nStringIdan_int8, g_nStringIdan_int16, g_nStringIdan_int32, g_nStringIdan_int64, g_nStringIda_uint8, g_nStringIda_uint16, g_nStringIda_uint32, g_nStringIda_uint64, g_nStringIda_float32, g_nStringIda_float64, g_nStringIda_char, g_nStringIda_string, g_nStringIda_bound_string, g_nStringIda_bound_string_string_bound, g_nStringIda_wstring, g_nStringIda_bound_wstring, g_nStringIda_bound_wstring_string_bound};

CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen::CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen() :
    CIEC_STRUCT(),
    var_a_bound_string_string_bound(2_ULINT),
    var_a_bound_wstring_string_bound(2_ULINT) {
}

CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen::CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen(const CIEC_BOOL &paa_bool, const CIEC_BYTE &paa_byte, const CIEC_SINT &paan_int8, const CIEC_INT &paan_int16, const CIEC_DINT &paan_int32, const CIEC_LINT &paan_int64, const CIEC_USINT &paa_uint8, const CIEC_UINT &paa_uint16, const CIEC_UDINT &paa_uint32, const CIEC_ULINT &paa_uint64, const CIEC_REAL &paa_float32, const CIEC_LREAL &paa_float64, const CIEC_CHAR &paa_char, const CIEC_STRING &paa_string, const CIEC_STRING &paa_bound_string, const CIEC_ULINT &paa_bound_string_string_bound, const CIEC_WSTRING &paa_wstring, const CIEC_WSTRING &paa_bound_wstring, const CIEC_ULINT &paa_bound_wstring_string_bound) :
    CIEC_STRUCT(),
    var_a_bool(paa_bool),
    var_a_byte(paa_byte),
    ...
    var_a_bound_string_string_bound(paa_bound_string_string_bound),
    var_a_wstring(paa_wstring),
    var_a_bound_wstring(paa_bound_wstring),
    var_a_bound_wstring_string_bound(paa_bound_wstring_string_bound) {
}
...
CIEC_ANY *CIEC_ROS2_conversiontests_msg_Ros2PrimitiveDatentypen::getMember(const size_t paIndex) {
  switch(paIndex) {
    ...
    case 2: return &var_an_int8;
    case 3: return &var_an_int16;
    case 4: return &var_an_int32;
    case 5: return &var_an_int64;
    case 6: return &var_a_uint8;
    case 7: return &var_a_uint16;
    case 8: return &var_a_uint32;
    case 9: return &var_a_uint64;
    ...
    case 15: return &var_a_bound_string_string_bound;
    case 16: return &var_a_wstring;
    case 17: return &var_a_bound_wstring;
    case 18: return &var_a_bound_wstring_string_bound;
  }
  return nullptr;
}
