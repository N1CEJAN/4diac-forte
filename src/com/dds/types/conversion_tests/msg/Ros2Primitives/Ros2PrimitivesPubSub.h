...
class Ros2PrimitivesPubSub : public CDDSPubSub {
  public:
    Ros2PrimitivesPubSub(std::string topicName, EPubSubRole role) :
      CDDSPubSub(topicName, role),
      m_type(new conversion_tests::msg::Ros2PrimitivesPubSubType()) {}
